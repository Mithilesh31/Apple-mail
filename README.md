...
<!-- mcp-name: io.github.Mithilesh31/apple-mail -->
...
[![GitHub stars](https://img.shields.io/github/stars/Mithilesh31/apple-mail-mcp?style=social)](https://github.com/Mithilesh31/apple-mail-mcp/stargazers)

## Star History

<a href="https://star-history.com/#Mithilesh31/apple-mail-mcp&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=Mithilesh31/apple-mail-mcp&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=Mithilesh31/apple-mail-mcp&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=Mithilesh31/apple-mail-mcp&type=Date" />
 </picture>
</a>
...
```bash
claude plugin marketplace add Mithilesh31/apple-mail-mcp
...
1. Download the latest `apple-mail-mcp-vX.Y.Z.mcpb` from [Releases](https://github.com/Mithilesh31/apple-mail-mcp/releases)
...
```bash
git clone https://github.com/Mithilesh31/apple-mail-mcp.git
...
- [Issues](https://github.com/Mithilesh31/apple-mail-mcp/issues)
- [Discussions](https://github.com/Mithilesh31/apple-mail-mcp/discussions)
